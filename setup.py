...
[Distribute](http://pypi.python.org/pypi/distribute).  We recommend
version 0.6.34 or higher since that is the version that was tested.
...
For additional background information on setup.py and related concepts,
